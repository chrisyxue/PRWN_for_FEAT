...
class FSLTrainer(Trainer):
    ...
    def train(self):
        ...
        for epoch in range(1, args.max_epoch + 1):
            ...
            # If fix_BN == True, we do not apply BN to the encoder
            if self.args.fix_BN:
                self.model.encoder.eval()
            ...
            for batch in self.train_loader:
                ...
                # print("Data",data.size()) [query+support,3,w,w]
                ...
                # get saved centers
                if args.is_ssl == 1:
                    proto, unlabelled, metric, logits, reg_logits = self.para_model(data)
                else:    
                ...
                if args.is_ssl == 1:
                    walker_loss, visit_loss, A, B = prw_loss(unlabelled,proto,args.tau,args.alpha,metric,temp=args.tempreture_ssl)
                    total_loss = total_loss + args.lamda*(walker_loss + visit_loss)
