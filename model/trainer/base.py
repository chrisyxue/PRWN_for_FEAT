...
class Trainer(object, metaclass=abc.ABCMeta):
    def __init__(self, args):
        ...
        self.trlog["val_acc_list"] = []
        self.trlog["val_loss_list"] = []
        self.trlog["val_error"] = []
    ...
    def try_evaluate(self, epoch):
        ...
        if self.train_epoch % args.eval_interval == 0:
            ...
            self.trlog["val_loss_list"].append(vl)
            self.trlog["val_acc_list"].append(va)
            self.trlog["val_error"].append(vap)
